...
/** Progress is advanced each `checkProgressFrameInterval` frames when exporting animation instead of each frame, due reduce the overhead of update the progress UI */
